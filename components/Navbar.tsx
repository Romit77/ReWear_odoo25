...
export default function Navbar() {
  ...
  // Mock session for demo - replace with your actual useSession hook
  const session = { user: { name: "John Doe", isAdmin: false } };
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <a href="/browse" className="relative group text-gray-300 hover:text-emerald-400 transition-all duration-300 font-medium">
              Browse
            ...
            <a href="/add-item" className="relative group text-gray-300 hover:text-emerald-400 transition-all duration-300 font-medium">
              Upload
              <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-emerald-400 to-teal-400 group-hover:w-full transition-all duration-300"></span>
            </a>
            {session?.user.isAdmin && (
              <a href="/admin" className="relative group text-gray-300 hover:text-emerald-400 transition-all duration-300 font-medium">
                Admin
                <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-emerald-400 to-teal-400 group-hover:w-full transition-all duration-300"></span>
              </a>
            )}
                ...
                <div className="relative">
                  ...
                  {isDropdownOpen && (
                    <div className="absolute right-0 mt-2 w-56 bg-gray-800/95 backdrop-blur-sm rounded-xl shadow-2xl border border-gray-700/50 overflow-hidden">
                      ...
                      <div className="py-2">
                        <a href="/profile" className="flex items-center px-4 py-3 text-gray-300 hover:text-emerald-400 hover:bg-gray-700/50 transition-all duration-300 group">
                        ...
                        <a href="/add-item" className="flex items-center px-4 py-3 text-gray-300 hover:text-emerald-400 hover:bg-gray-700/50 transition-all duration-300 group">
                          <div className="w-8 h-8 rounded-lg bg-gray-700 flex items-center justify-center mr-3 group-hover:bg-emerald-600 transition-all duration-300">
                            <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="border-t border-gray-700/50 mt-2 pt-2">
                          <button className="w-full flex items-center px-4 py-3 text-red-400 hover:text-red-300 hover:bg-red-900/20 transition-all duration-300 group">
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden border-t border-gray-800 mt-4 pt-4 pb-4">
            <div className="space-y-2">
              <a href="/browse" className="block px-4 py-2 text-gray-300 hover:text-emerald-400 hover:bg-gray-800 rounded-lg transition-all duration-300">
                Browse
              </a>
              <a href="/add-item" className="block px-4 py-2 text-gray-300 hover:text-emerald-400 hover:bg-gray-800 rounded-lg transition-all duration-300">
                Upload
              </a>
              {session?.user.isAdmin && (
                <a href="/admin" className="block px-4 py-2 text-gray-300 hover:text-emerald-400 hover:bg-gray-800 rounded-lg transition-all duration-300">
                  Admin
                </a>
              )}
            </div>
